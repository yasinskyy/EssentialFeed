//
//  UIViewShimmering.swift
//  EssentialFeediOS
//
//  Created by Work on 20.03.2025.
//
...
extension UIView {
    ...
    private class ShimmeringLayer: CAGradientLayer {
        private static var shimmerAnimationKey: String { return "shimmer" }
        ...
        convenience init(size: CGSize) {
            ...
            add(animation, forKey: ShimmeringLayer.shimmerAnimationKey)
            ...
            observer = NotificationCenter.default.addObserver(forName: UIApplication.willEnterForegroundNotification, object: nil, queue: nil) { [weak self] _ in
                self?.add(animation, forKey: ShimmeringLayer.shimmerAnimationKey)
            }
        }
    }
}
